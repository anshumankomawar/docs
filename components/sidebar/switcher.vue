...
<template>
  <Select v-model="selectedEmail">
    <SelectTrigger aria-label="Select account"
      class="h-8 flex items-center gap-2 [&>span]:line-clamp-1 [&>span]:flex [&>span]:w-full [&>span]:items-center [&>span]:gap-1 [&>span]:truncate [&_svg]:h-4 [&_svg]:w-4 [&_svg]:shrink-0 border-none">
